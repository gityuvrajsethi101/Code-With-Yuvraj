...
<head>
    ...
    <script src="https://kit.fontawesome.com/5808305676.js" crossorigin="anonymous"></script>
    <!-- External CSS -->
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <div class="profilebtn" style="margin-bottom:0px;">
                    <a href="https://www.linkedin.com/in/uvsethi90/" class="btn"><span>View my profile</span>
        ...
        <div class="flex flex-wrap -m-4">
            <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
                <div class="h-full text-center">
                    <img alt="testimonial" class="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="./images/student1.png">
            ...
            <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
                <div class="h-full text-center">
                    <img alt="testimonial" class="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="./images/student2.png">
                    <p class="leading-relaxed">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                    <span class="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a class="text-indigo-500">uvsethi425@email.com</a>
...
<section class="footer">
  ...
  <div class="box-container">
      ...
      <div class="box">
          ...
          <p> <i class="fas fa-envelope"></i>uvsethi425@gmail.com</p>
          <p> <i class="fas fa-map-marked-alt"></i>Moradabad,UP, India</p>
          <div class="share">
              <a href="https://www.linkedin.com/in/uvsethi90/" class="fab fa-linkedin" aria-label="LinkedIn" target="_blank"></a>
              <a href="https://github.com/" class="fab fa-github" aria-label="GitHub" target="_blank"></a>
              <a href="mailto:uvsethi425@gmail.com" class="fas fa-envelope" aria-label="Mail" target="_blank"></a>
              <a href="https://t.me/sethi_11" class="fab fa-telegram-plane" aria-label="Telegram" target="_blank"></a>
              <a href="https://www.youtube.com/ " target="_blank" class="fa-brands fa-youtube" aria-label="Youtube"></a>
          </div>
      </div>
  </div>

  <h1 class="credit">Designed with <i class="fa fa-heart pulse"></i> by <a href="https://www.linkedin.com/in/uvsethi90/">Yuvraj Sethi </a></h1>
